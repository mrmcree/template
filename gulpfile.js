...
var stylus = require('gulp-stylus') // stylus编译
...
var html_main_path = 'src/*.html'
var js_libs_path = 'src/js/libs/*.js'
var js_main_path = 'src/js/*.js'
var css_libs_path = 'src/css/*.css'
var css_main_path = 'src/css/*.{css,styl}'
var images_path = ['src/asset/**', 'favicon.ico']
...
gulp.task('images', function() {
    return gulp.src(images_path)
        ...
        .pipe(gulpif(env === 'dev', cache(imagemin({
            optimizationLevel: 7, // 取值范围：0-7（优化等级），默认：3
